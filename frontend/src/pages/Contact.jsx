      ...
      <div className="max-w-2xl mx-auto my-6 px-4 sm:px-6 lg:px-8 py-8 border border-gray-300 rounded-lg">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl">
            "We'd love to hear from you. Whether it's a question, suggestion, or prayer request, feel free to reach out."
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full border-b-2 border-gray-300 bg-transparent py-2 focus:outline-none focus:border-ayBlue transition-colors"
                />
              </div>
              ...
              <div className="space-y-2">
                <label htmlFor="location" className="text-xl font-bold text-gray-600">
                  Location:
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                <label htmlFor="message" className="text-xl font-bold text-gray-600">
                  Message:
                </label>
                <textarea
                  id="message"
                  ...
                  required
                  rows={4}
                  className="w-full border-b-2 border-gray-300 bg-transparent py-2 focus:outline-none focus:border-ayBlue transition-colors resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full bg-ayBlue text-white py-4 rounded font-semibold text-lg hover:bg-opacity-90 transition-colors"
              >
                Send
              </button>
            </form>
          ...
          <div className="space-y-12 justify-center my-6 place-items-center max-sm:grid max-sm:grid-cols-2">
            ...
            <div>
              ...
              <div className="space-y-4 text-lg text-gray-600">
                <p className="font-semibold">📍 KN 15 Ave, Ubumwe Road</p>
                <p className="font-semibold">Kigali City, Rwanda</p>
              </div>
            </div>
